...
<html lang="es">
	<head>
		...
		<title>Formulario Para Personal Técnico</title>
		<link rel="icon" href="../img/fav.png">
		<link rel="stylesheet" href="../css/formulario.css" type="text/css">
	</head>
	<body onunload="saliste">
		<div id="contenido">
			<?php include "../cgl/superu.CGL"; ?>
			<form name="formpersonaltecnico" action="proc_personaltecnico.php" method="post" id="formulario">
				<p class="titulo">Forma parte de nuestro equipo</p>
				<div class"form">
					<p class="datos">Formulario Para Personal Técnico</p>
					<li class="disciplina">
						<div>
					...
					<li>
					    ...
					    <input name="profesion" type="text" min="2" max="40" required/>
					</li>
					<li>
					...
					<li>
					    ...
					    <input name="estudios" type="text" min="2" max="50" required/>
					</li>
				    <li>
				    	<label>Experiencia Laboral</label>
					    <input name="experiencia" type="text" min="2" max="50" required/>
				    </li>
					<li>
