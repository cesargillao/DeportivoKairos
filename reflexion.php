...
<html lang="es">
	<head>
		...
		<title>Deportivo Kairos | Reflexión</title>
		<link rel="icon" href="img/fav.png">
		<link rel="stylesheet" type="text/css" href="css/index.css">
		<link rel="stylesheet" type="text/css" href="css/slideshow.css">
		<link rel="stylesheet" type="text/css" href="css/fonts.css">
		<link rel="stylesheet" type="text/css" href="css/reflexion.css">
			...
			<div id="contenedor">
				<div id="contenido">
					<?php
						...
						$query = mysql_query('SELECT * FROM reflexion ORDER BY ID DESC') or die('Consulta fallida: '.mysql_error());
						while($fila = mysql_fetch_array($query, MYSQL_ASSOC)){
							echo
							'<article class="shortarticle">
